# 🐍 Python Exercises - Curso em Vídeo (Gustavo Guanabara)
This repository brings together my solutions to the challenges proposed by professor Gustavo Guanabara in the renowned Python course from the Curso em Vídeo channel.
